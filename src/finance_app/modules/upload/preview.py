"""Statement upload preview parsing and response shaping.

This module owns read-only CSV decoding and preview row construction for the
upload form. It does not query or mutate the database.
"""
