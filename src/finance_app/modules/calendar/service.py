...
def build_calendar_context(args: Any) -> dict[str, Any]:
    ...
    days = build_calendar_days(month_start, recurring_context["transactions"], account_id=selected_account_id)
...
def build_recurring_activity_context(
    ...
    with db_core_transaction() as conn:
        ...
        transactions = build_calendar_transactions(month_rows, conn, account_id=selected_account_id)
