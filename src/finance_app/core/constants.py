...
STATEMENT_IMPORT_MODES = {
    STATEMENT_IMPORT_MODE_LEDGER: "Adds transactions",
    STATEMENT_IMPORT_MODE_ENRICHMENT: "Updates existing transactions",
}
...
DATE_ORDERS = {
    DATE_ORDER_AUTO: "Auto-detect",
    DATE_ORDER_MONTH_FIRST: "MM/DD/YYYY",
    DATE_ORDER_DAY_FIRST: "DD/MM/YYYY",
}
