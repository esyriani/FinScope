...
def reportable_transaction_clause():
...
def tagged_transfer_credit_clause():
...
def reportable_or_tagged_transfer_credit_clause(include_transfer_credits=False):
...
def income_or_tagged_transfer_credit_clause(include_transfer_credits=False):
